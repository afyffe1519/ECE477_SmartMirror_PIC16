...
# 1 "mcc_generated_files/i2c2_driver.c"
...
# 30 "mcc_generated_files/i2c2_driver.c"
...
if(PIR2bits.SSP2IF == 0)
{
while(1)
{
if(PIR2bits.SSP2IF) break;
